    ...
    <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
      ...
      <main aria-label="Main"
        ...
        <div class="max-w-xl lg:max-w-3xl">
          ...
          <form @submit.prevent="registerHandler" class="mt-8 grid grid-cols-6 gap-6">
            ...
            <div class="col-span-6 sm:col-span-3">
              ...
              <input type="password" id="PasswordConfirmation" name="password_confirmation" v-model="password_confirm"
                class="mt-1 w-full rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm" />
            </div>
...
function registerHandler() {
  store.register(name.value, email.value, password.value, password_confirm.value)
}
